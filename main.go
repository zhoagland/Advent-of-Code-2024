...
func main() {
	...
	fmt.Print("Day 5 Part 1 Answer: ")
	fmt.Println(day5.Day5Part1("./Day5/Input.txt"))
	fmt.Print("Day 5 Part 2 Answer: ")
	fmt.Println(day5.Day5Part2("./Day5/Input.txt"))
}
